...
namespace Polytope
{
    ...
    public class PT_Create_Prefab_Editor : Editor
    {
        ...
        private void ShaderProperty_C(string name, string label)
        {
            ...
            UnityEngine.Material mat = (material.FindPropertyRelative("instance").objectReferenceValue as UnityEngine.Material);
        ...
        private void ShaderProperty_UTL()
        {
            ...
            if (IsMaterialProperty("_MetalicOn"))
            {
                ...
                if (metallic != (materialInstance.objectReferenceValue as UnityEngine.Material).GetFloat("_MetalicOn"))
                {
                    (materialInstance.objectReferenceValue as UnityEngine.Material).SetFloat("_MetalicOn", metallic);
                }
            }
            ...
            if (IsMaterialProperty("_SmoothnessOn"))
            {
                ...
                if (smoothness != (materialInstance.objectReferenceValue as UnityEngine.Material).GetFloat("_SmoothnessOn"))
                {
                    (materialInstance.objectReferenceValue as UnityEngine.Material).SetFloat("_SmoothnessOn", smoothness);
                }
            }
            ...
            if (IsMaterialProperty("_OCCLUSION"))
            {
                ...
                if (occlusion.floatValue != (materialInstance.objectReferenceValue as UnityEngine.Material).GetFloat("_OCCLUSION"))
                {
                    (materialInstance.objectReferenceValue as UnityEngine.Material).SetFloat("_OCCLUSION", occlusion.floatValue);
                }
            }
            ...
            (materialInstance.objectReferenceValue as UnityEngine.Material).enableInstancing = gpuinstancing.boolValue;
            (materialInstance.objectReferenceValue as UnityEngine.Material).doubleSidedGI = doubleSidedGI.boolValue;
            (materialInstance.objectReferenceValue as UnityEngine.Material).renderQueue = renderQueue.intValue;
        }
        ...
        private void ShaderDropDownSelection()
        {
            ...
            {
                materialNames.Add((list.GetArrayElementAtIndex(i).objectReferenceValue as UnityEngine.Material).name);
            }
            ...
            {
                idx.intValue = index;
                material.FindPropertyRelative("instance").objectReferenceValue = new UnityEngine.Material(list.GetArrayElementAtIndex(index).objectReferenceValue as UnityEngine.Material);
                ReapplyMaterials();
            }
        }
        ...
        private bool IsMaterialProperty(string name)
        {
            try
            {
                return (material.FindPropertyRelative("instance").objectReferenceValue as UnityEngine.Material).HasProperty(name);
            }
        ...
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
            UnityEngine.Material dftmat = material.FindPropertyRelative("assets").GetArrayElementAtIndex(material.FindPropertyRelative("index").intValue).objectReferenceValue as UnityEngine.Material;
        ...
        private void PrefabCreate()
        {
            ...
            {
                mat = new UnityEngine.Material(smrs[0].sharedMaterial);
                ...
                path = path.Replace('\\', '/');
                int count = GetAssetsAtPath<UnityEngine.Material>(path).Length;
            ...
            else
            {
                ...
                mat = assets.GetArrayElementAtIndex(index.intValue).objectReferenceValue as UnityEngine.Material;
            }
        ...
        private void ReloadMaterials()
        {
            ...
            UnityEngine.Material dm = PrefabUtility.GetCorrespondingObjectFromSource(script.gameObject).GetComponentInChildren<SkinnedMeshRenderer>().sharedMaterial;
            string path = AssetDatabase.GetAssetPath(dm);
            Debug.Log("Default material is: " + dm.name);
            string name = Path.GetFileNameWithoutExtension(path);
            path = Path.GetDirectoryName(path);
            path = path.Replace('\\', '/');
            UnityEngine.Material[] materials = GetAssetsAtPath<UnityEngine.Material>(path);
            ...
            material.FindPropertyRelative("instance").objectReferenceValue = new UnityEngine.Material(dm);
        }
            ...
            for (int i = 0; i < meshes.arraySize; i++)
            {
                ...
                for (int k = 0; k < listOfMeshes.arraySize; k++)
                {
                    (listOfMeshes.GetArrayElementAtIndex(k).objectReferenceValue as SkinnedMeshRenderer).sharedMaterial =
                        material.FindPropertyRelative("instance").objectReferenceValue as UnityEngine.Material;
                }
            }
            serializedObject.ApplyModifiedProperties();
